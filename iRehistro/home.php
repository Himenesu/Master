                ...
                <div class="wrapper">
                    ...
                    <div class="form">
                       ...
                       <div class="inputfield">
                          ...
                          <input type="text" name="midname" class="input" placeholder="Iyong gitnang pangalan" minlength="5" required>
                       </div>   
                        <div class="inputfield">
                       ...
                       <div class="inputfield">
                          ...
                          <input type="text" name="birthdate" class="input" placeholder="Halimbawa: 01-24-2002" required>
                       </div>   
                        <div class="inputfield">
                    ...
                    <div class="form">
                        ...
                        <div class="inputfield">
                            <div class="form-group">
                                <input class="form-control button" type="submit" name="register" value="Continue">
                            </div>
                        </div>
                    </div>
                </div>
