...
if(isset($_POST['signup'])){
   ...
   //if login now button click
    ...
    if(isset($_POST['register'])){
        ...
        $update_pass = "UPDATE usertable SET firstname = '$firstname', midname = '$midname', lastname = '$lastname', birthdate = '$birthdate', birthplace = '$birthplace', 
        sex = '$sex', civil = '$civil', contact = '$contact', citizen = '$citizen', acquisition = '$acquisition', province = '$province', city = '$city', 
        ...
        $run_query2 = mysqli_query($con, $update_pass);
        if($run_query2){

            $info2 = "You submitted your form";
            $_SESSION['info'] = $info2;
            ...
            echo "Error submitting the form" . mysqli_error($con);
